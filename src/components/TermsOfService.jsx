    ...
    <div className="bg-background text-foreground">
      <div className="container mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          <section>
            <h2 className="mb-4 text-2xl font-bold">Mobile App Terms of Use</h2>
            <div className="prose text-foreground">
              <p>Version 1.0.</p>
              <p>
                The Grosco website (Or mobile app) located at{" "}
                <a
                  className="text-blue-600 visited:text-purple-600"
                  href="https://www.grosco.in"
                >
                  grosco.in
                </a>{" "}
                is a copyrighted work belonging to Grosco. Certain features of
                the Site may be subject to additional guidelines, terms, or
          ...
          <section>
            <h2 className="mb-4 text-2xl font-bold">Legally Binding Terms</h2>
            <div className="prose text-foreground">
              <p>
                These Terms of Use describe the legally binding terms and
                conditions that oversee your use of the Site.{" "}
                <strong>
                  BY LOGGING INTO THE SITE, YOU AGREE TO THESE TERMS
                </strong>{" "}
                and represent that you have the authority and capacity to enter
                into these Terms.{" "}
                <strong>
                  YOU SHOULD BE AT LEAST 18 YEARS OLD TO ACCESS THE SITE. IF YOU
                  DISAGREE WITH ANY PROVISIONS OF THESE TERMS, DO NOT LOG INTO
                  OR USE THE SITE
                </strong>
                .
              </p>
              <p>
                ...
                basis to resolve disputes and limit the remedies available to
          ...
          <section>
            <h2 className="mb-4 text-2xl font-bold">Access to the Site</h2>
            <div className="prose text-foreground">
              <p>
                Subject to these Terms, the company grants you a
                non-transferable, non-exclusive, revocable, limited license to
                access the Site solely for personal, noncommercial use.
              </p>
            </div>
          </section>

          <section>
            <h2 className="mb-4 text-2xl font-bold">Restrictions</h2>
            <div className="prose text-foreground">
              <p>
              ...
              <ul className="list-disc pl-5">
                <li>
                  ...
                  host, or commercially exploit the Site.
                </li>
                <li>
                  You shall not make derivative works of or reverse engineer any
                  part of the Site.
                </li>
                <li>
                  You shall not access the Site to build a similar or
                  competitive website.
                </li>
                <li>
                  No part of the Site may be copied, reproduced, distributed,
                  republished, downloaded, posted, or transmitted without
                  permission.
                </li>
              </ul>
            </div>
          ...
          <section>
            <h2 className="mb-4 text-2xl font-bold">Third-Party Links & Ads</h2>
            <div className="prose text-foreground">
              <p>
                The Site may contain links to third-party websites and services,
                or display advertisements. These are not controlled by the
                company, and the company is not responsible for them.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="prose text-foreground">
              <p>
                ...
                any kind arising from or relating to this agreement. Some
          ...
          <section>
            <h2 className="mb-4 text-2xl font-bold">Term and Termination</h2>
            <div className="prose text-foreground">
              <p>
                ...
                your Account may involve deletion of your User Content
                ...
                rights under these Terms are terminated, the following
                provisions of these Terms will remain in effect: Sections 2
          ...
          <section>
            <h2 className="mb-4 text-2xl font-bold">Copyright Policy</h2>
            <div className="prose text-foreground">
              <p>
          ...
          <section>
            ...
            <div className="prose text-foreground">
              ...
              <p>
                ...
                carefully. It is part of your contract with Company and affects
                your rights. It contains procedures for MANDATORY BINDING
            ...
            <p>
              ...
              resolved informally or in small claims court shall be resolved by
              ...
              users or beneficiaries of services or goods provided under the
              Terms.
            </p>
            <h3 className="mb-4 mt-2 text-xl font-bold">
            ...
            <p>
              ...
              relief. A Notice to the Company should be sent to: Guwahati,
              Assam. After the Notice is received, you and the Company may
              ...
              arbitration proceeding. The amount of any settlement offer made by
              ...
              party is entitled. Arbitration Rules. Arbitration shall be
              initiated through the American Arbitration Association, an
              established alternative dispute resolution provider that offers
              arbitration as set forth in this section. If AAA is not available
              to arbitrate, the parties shall agree to select an alternative ADR
              Provider. The rules of the ADR Provider shall govern all aspects
              of the arbitration except to the extent such rules are in conflict
              with the Terms. The AAA Consumer Arbitration Rules governing the
              arbitration are available online at adr.org or by calling the AAA
              ...
              competent jurisdiction. If the arbitrator grants you an award that
              ...
              you the greater of the award or $2,500.00. Each party shall bear
            ...
            <h3 className="mb-4 mt-2 text-xl font-bold">Time Limits.</h3>
            <p>
              If you or the Company pursues arbitration, the arbitration action
              must be initiated and/or demanded within the statute of
              limitations and within any deadline imposed under the AAA Rules
            ...
            <p>
              ...
              and liabilities of you and the Company, and the dispute will not
            ...
            <p>
              ...
              expensive than rules applicable in a court and are subject to very
              limited review by a court. In the event any litigation should
              arise between you and the Company in any state or federal court in
              a suit to vacate or enforce an arbitration award or otherwise, YOU
            ...
            <h3 className="mb-4 mt-2 text-xl font-bold">Confidentiality.</h3>
            <p>
            ...
            <h3 className="mb-4 mt-2 text-xl font-bold">Severability.</h3>
            <p>
            ...
            <h3 className="mb-4 mt-2 text-xl font-bold">Small Claims Court.</h3>
            <p>
            ...
            <p>
              Anyhow the foregoing, either party may seek emergency equitable
              relief before a state or federal court in order to maintain the
              status quo pending arbitration. A request for interim measures
              shall not be deemed a waiver of any other rights or obligations
            ...
            <p>
              ...
              Agreement. In any circumstances where the foregoing Arbitration
              ...
              export laws or regulations. Company is located at the address in
              ...
              Consumer Product of the California Department of Consumer Affairs
          ...
          <section>
            ...
            <div className="prose text-foreground">
              <p>
                Address: Guwahati, Assam <br />
                Phone: 7002435218 <br />
                Email: grosco.ghy@gmail.com
              </p>
            </div>
          </section>
        </div>
