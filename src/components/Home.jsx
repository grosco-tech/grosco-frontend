        ...
        <div className="container mx-auto flex flex-col items-center justify-center text-center text-white">
          ...
          <div className="flex items-center gap-4">
            <Input
              ...
              className="flex-1 rounded-md bg-white/80 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
            />
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <Card>
              <CardContent className="flex flex-col items-center justify-center p-6">
                ...
                />
                <h3 className="mb-2 text-lg font-semibold">Fresh Avocados</h3>
                <p className="mb-4 text-muted-foreground">$2.99 / lb</p>
                <Button variant="solid" size="sm">
                  Add to Cart
                </Button>
              </CardContent>
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center p-6">
                <img
                  ...
                  className="mb-4 rounded-md"
                />
                <h3 className="mb-2 text-lg font-semibold">Organic Spinach</h3>
                <p className="mb-4 text-muted-foreground">$3.49 / bunch</p>
                <Button variant="solid" size="sm">
                  Add to Cart
                </Button>
              </CardContent>
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center p-6">
                <img
                  ...
                  className="mb-4 rounded-md"
                />
                <h3 className="mb-2 text-lg font-semibold">Free-Range Eggs</h3>
                <p className="mb-4 text-muted-foreground">$4.99 / dozen</p>
                <Button variant="solid" size="sm">
                  Add to Cart
                </Button>
              </CardContent>
            ...
            <Card>
              <CardContent className="flex flex-col items-center justify-center p-6">
                <img
                  ...
                  className="mb-4 rounded-md"
                />
                <h3 className="mb-2 text-lg font-semibold">Grass-Fed Beef</h3>
                <p className="mb-4 text-muted-foreground">$9.99 / lb</p>
                <Button variant="solid" size="sm">
                  Add to Cart
                </Button>
              </CardContent>
